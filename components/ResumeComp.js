        ...
        <Card>
          ...
          <Accordion.Collapse eventKey="1">
            <Card.Body>
                <h4>Certificates</h4>
              <ul className="list-group">
                <li className="list-group-item">Full Stack Web Development - <em>HyperionDev</em>-2020-Current</li>
                <li className="list-group-item">Project Management Fundamentals - <em>The Learning Organisation</em>-2017-2018</li>
                <li className="list-group-item">ICT End User Computing -<em>The Learning Organisation</em>-2018-2019</li>
                <h4>Degree</h4>
                <li className="list-group-item">BA(Organisational Psychology and Linguistics) -<em>WITS</em>-2014-2017</li>
              </ul>
            </Card.Body>
          </Accordion.Collapse>
        </Card>
